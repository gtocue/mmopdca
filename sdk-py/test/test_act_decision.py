...
class TestActDecision(unittest.TestCase):
    """ActDecision unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActDecision:
        """Test ActDecision
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ActDecision`
        """
        model = ActDecision()
        if include_optional:
            return ActDecision(
