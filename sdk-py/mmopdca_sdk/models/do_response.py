...
class DoResponse(BaseModel):
    ...
    seq: Annotated[int, Field(strict=True, ge=1)] = Field(description="DoCreateRequest.run_no のエコーバック（互換: 'seq'）")
    run_tag: Optional[StrictStr] = None
    status: DoStatus = Field(description="ジョブ状態")
    result: Optional[Dict[str, Any]] = None
    artifact_uri: Optional[StrictStr] = None
    dashboard_url: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2083)]] = None
    __properties: ClassVar[List[str]] = ["do_id", "plan_id", "seq", "run_tag", "status", "result", "artifact_uri", "dashboard_url"]
