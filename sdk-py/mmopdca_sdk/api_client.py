...
from mmopdca_sdk.api_response import ApiResponse, T as ApiResponseT
import mmopdca_sdk.models
from mmopdca_sdk import rest
from mmopdca_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(mmopdca_sdk.models, klass)
